...
const Footer = () => {
  return (
    <footer className="h-120 bg-project-blue text-project-white">
      <h1 className="font-playfair text-project-white pt-28 pb-12 pl-12 font-bold text-2xl">
        Enjoyment has many facets...
      </h1>
      <p className="font-montserrat pl-12 pr-14">
