...
const Header = () => {
	...
	return (
		<header className="pt-16 pl-12 bg-project-blue text-project-white h-120 pb-14 pr-14">
			<div>
				<h1 className="pb-2 font-normal font-playfair text-heading">
					Cocktails & Drinks
				</h1>
				<p className="pb-10 text-xs leading-5 font-montserrat">
